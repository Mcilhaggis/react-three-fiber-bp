...
//   Without useMemo the colorus with change to something new and random every time
  const colorTo = 
  useMemo(
    () => new Color(Math.floor(Math.random() * 16777216)),
    []
  )
// You can use damp to get an exact repositioning instead of lerp which never goes back to the original position/number
  useFrame(() => {
